// File:	      CSearchBreadthFirst.hpp
// Author:	      Mark Ince
// Date:	      28-12-2018
// Last Edited:   02-02-2019
//
// Declaration of Search class for BreadthFirst algorithm
//
...
// BreadthFirst search class definition
// Inherit from interface and provide implementation for Breadth-First algorithm
// This class performs a Breadth-first search. 
...
public:
	...
	CSearchBreadthFirst();                                                         // Constructor
	...
	~CSearchBreadthFirst();                                                        // Destructor
};
